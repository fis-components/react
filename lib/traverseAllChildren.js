...
function traverseAllChildrenImpl(children, nameSoFar, callback, traverseContext) {
  ...
  if (Array.isArray(children)) {
    ...
    if (iteratorFn) {
      ...
      !false ? true ? invariant(false, 'Objects are not valid as a React child (found: %s).%s', childrenString === '[object Object]' ? 'object with keys {' + Object.keys(children).join(', ') + '}' : childrenString, addendum) : invariant(false) : undefined;
    }
  }
