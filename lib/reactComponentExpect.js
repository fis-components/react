...
function reactComponentExpect(instance) {
  ...
  !ReactTestUtils.isCompositeComponent(instance) ? true ? invariant(false, 'reactComponentExpect(...): instance must be a composite component') : invariant(false) : undefined;
